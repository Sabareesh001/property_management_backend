...
-- CreateIndex
CREATE UNIQUE INDEX "quoted_property_units_primary_pricing_id_key" ON "quoted_property_units"("primary_pricing_id");
...
-- AddForeignKey
ALTER TABLE "quotations" ADD CONSTRAINT "quotations_original_property_id_fkey" FOREIGN KEY ("original_property_id") REFERENCES "property_units"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "quotations" ADD CONSTRAINT "quotations_quoted_property_id_fkey" FOREIGN KEY ("quoted_property_id") REFERENCES "quoted_property_units"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
